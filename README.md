...
- [Jellyfin Telegram Channel Sync](https://github.com/GeiserX/jellyfin-telegram-channel-sync) - Automated Jellyfin access control through Telegram channel membership verification.
