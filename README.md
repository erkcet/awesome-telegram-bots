...
- [@QuickRadarBot](https://t.me/QuickRadarBot) - No-code crypto alerts and cross-exchange arbitrage monitoring via a Telegram Mini App builder — price, funding, open interest, and executable spread across 14 exchanges.
